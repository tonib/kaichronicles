...
// *** TONIB: Imports TLSSocketFactory
import java.io.IOException;
...
public class FileTransfer extends CordovaPlugin {
    ...
    // *** TONIB
    /**
     * SSLSocketFactory proxy to enable TLS 1.2 on Android 4.4.
    ...
    private static class TLSSocketFactory extends SSLSocketFactory {
        ...
        /**
         * Create a default socket factory proxy
         */
        ...
        /**
         * Create a socket factory proxy for a given factory
    ...
    /**
     * *** TONIB: Return true if the Socket factory should be patched
     */
    private static boolean TlsShouldBePatched() {
        // Between these versions, TLS 1.2 was implemented but not enabled.
        // projectaon.org only supports TLS 1.2
        // So wee need to create a proxy for the SSL factory
        boolean patchNeeded = Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT <= 19;
        LOG.d( LOG_TAG, "API " + Build.VERSION.SDK_INT + ": " + ( patchNeeded ? "TLS PATCH NEEDED" : "TLS patch not needed" ) );
        return patchNeeded;
    }
    ...
    private static SSLSocketFactory trustAllHosts(HttpsURLConnection connection) {
        ...
        LOG.d( LOG_TAG, "Trusting everyone....");
        ...
        try {
            ...
            // *** TONIB: Enable TLS1.2 on Android 4.4
            SSLSocketFactory newFactory = sc.getSocketFactory();
            if( TlsShouldBePatched() )
                newFactory = new TLSSocketFactory( newFactory );
            ...
            public void run() {
                ...
                try {
                    ...
                    if (isLocalTransfer) {
                        ...
                        // *** TONIB: Enable TLS1.2 on Android 4.4
                        if(useHttps && connection instanceof HttpsURLConnection && TlsShouldBePatched() ) {
                            try {
                                LOG.d( LOG_TAG, "Enabling TLS 1.2" );
                                HttpsURLConnection https = (HttpsURLConnection)connection;
                                https.setSSLSocketFactory( new TLSSocketFactory() );
                            }
                            catch(Exception exSetSSLFactory) {
                                LOG.e( LOG_TAG, "Error enabling TLS 1.2", exSetSSLFactory);
                            }
                        }
