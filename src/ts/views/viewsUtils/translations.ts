...
class Translations {
    ...
    private readonly es = {
        ...
        "aboutKaiChronicles" : "Mecánicas del juego escritas por Toni Bennasar, Timendum, Michael Terry, Javier Fernández-Sanguino, James Koval, Rendall, Garrett Scott, Julian Egelstaff y Cracrayol. El código está bajo licencia MIT. Contien partes de código de Lone Wolf Adventures, creado por Liquid State Limited.",
